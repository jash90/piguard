...
export function SocialMediaPage() {
  const platforms = useQuery(api.socialPlatforms.list, {})
  const children = useQuery(api.children.list, {})
  const seedPlatforms = useMutation(api.socialPlatforms.seedPredefined)
  const addCustom = useMutation(api.socialPlatforms.addCustom)
